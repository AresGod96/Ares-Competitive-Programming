/* 
	...
	- Problem: CF ROUND 1433 E - Two Round Dances
	- Problem link: http://codeforces.com/contest/1433/problem/E
*/
...
int Ares_KN() // main
{
	...
	// Ways to choose first (n/2) people without rotation = n! / (n / 2)! / (n / 2)
	// Ways to choose second (n/2) people without rotation = (n / 2 - 1)!
	// combine then divide by 2 due to unordered
	ll res = fact[n - 1] * 2 / n;
	printf("%lld\n", res);
	return 0;
}
