/* 
	...
	- Problem: CF ROUND 1433 C - Dominant Piranha
	- Problem link: http://codeforces.com/contest/1433/problem/C
*/
...
int Ares_KN() // main
{
	...
	while (nTest--) {
		...
		int res = -1;
		if (a[0] == max_value && a[0] > a[1]) res = 1;
		if (a.back() == max_value && a.back() > a[n - 2]) res = n;
		FOR(i, 1, n - 2)
			if (a[i] == max_value) {
