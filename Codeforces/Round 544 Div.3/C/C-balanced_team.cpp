/* 
	...
	- Problem: CF ROUND 1133 C - Balanced Team
	- Problem link: https://codeforces.com/contest/1133/problem/C
*/
...
int Ares_KN() // main
{
	...
	REP(i, n)
	{
		auto upper = upper_bound(begin(a), end(a), a[i] + 5);
		if (upper ==  a.end()) res = max(res, n - i);
		else
		{
			int tmp = upper - a.begin() - i;
			res = max(res, tmp);
		}
	}
	printf("%d\n", res);
