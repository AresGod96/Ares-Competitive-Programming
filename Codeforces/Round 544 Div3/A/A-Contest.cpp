/* 
	...
	- Problem: CF ROUND 1133 A - Middle of the Contest
	- Problem link: https://codeforces.com/contest/1133/problem/A
*/
...
int Ares_KN() // main
{
	...
	scanf("%d:%d", &h1, &m1);
	scanf("%d:%d", &h2, &m2);
	int d = (h1 * 60 + m1 + h2 * 60 + m2) / 2;

	int h = d / 60, m = d % 60;
	string hh = toStr(h), mm = toStr(m);
