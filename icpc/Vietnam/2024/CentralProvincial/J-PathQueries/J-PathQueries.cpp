/* 
	...
	- Problem: ICPC Vietnam Central Provincial 2024 - J - Path Queries
	- Problem link: https://oj.vnoi.info/problem/icpc24_mt_j
*/
#define LOCAL
#undef LOCAL
...
int Ares_KN() // main
{
	...
	while (q--) {
		int u, v, mid;
		cin >> u >> mid >> v;
		if (lca.get_dist(u, v) == lca.get_dist(u, mid) + lca.get_dist(mid, v)) {
			puts("YES");
		}
		else {
			puts("NO");
