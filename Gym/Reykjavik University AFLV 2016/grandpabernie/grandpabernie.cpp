/* 
	...
	- Problem: Reykjavík University ÁFLV 2016 - Grandpa Bernie
	- Problem link: https://open.kattis.com/problems/grandpabernie
*/
#define LOCAL
#undef LOCAL
...
int Ares_KN() // main
{
	...
	REP(i, n) {
		...
		int year;
		cin >> s >> year;
		trip[s].push_back(year);
	}
	for (auto &[key, value]: trip)
		if (value.size() > 0) {
