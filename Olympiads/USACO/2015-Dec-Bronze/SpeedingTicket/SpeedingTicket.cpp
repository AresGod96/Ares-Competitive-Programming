/* 
	...
	- Problem: USACO 2015 December Bronze - Speeding Ticket
	- Problem link: http://www.usaco.org/index.php?page=viewproblem2&cpid=568
	- Problem link: https://www.acmicpc.net/problem/11971
*/
#define LOCAL
#undef LOCAL
...
int Ares_KN() // main
{
	...
	while (n--)	 {
		int to, speed;
		cin >> to >> speed;
		FOR(i, cur, cur + to - 1) max_speed[i] = speed;
		cur += to;
	}
