/* 
	...
	- Problem: Free Contest 146 - DIV3
	- Problem link: https://oj.vnoi.info/problem/fc146_div3
	- Solution: dynamic programming O(L)
*/
#define LOCAL
#undef LOCAL
...
int Ares_KN() // main
{
	...
	// dp[i][j]: max digits to take considering i-th digit such that the number % 3 = j
